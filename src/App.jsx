...
const QUESTIONS = [
  ...
  {
    question: "هُمْ ______ الكَثِيرَ.",
    verb: "(فَعَلَ - هم - hacer)",
  ...
  // -------------------- قَرَأَ (leer) --------------------
  {
    question: "أَنْتَ ______ الكِتَابَ.",
    verb: "(قَرَأَ - leer)",
  ...
  {
    question: "فَاطِمَةُ ______ الْقُرْآنَ.",
    verb: "(قَرَأَ - هي - leer)",
  ...
  {
    question: "هُمْ ______ الْجَرِيدَةَ.",
    verb: "(قَرَأَ - هم - leer)",
  ...
  // -------------------- ذَهَبَ (ir) --------------------
  {
    question: "فَاطِمَةُ ______ إِلَى السُّوقِ.",
    verb: "(ذَهَبَ - هي - ir)",
  ...
  {
    question: "أَنَا ______ إِلَى الْجَامِعَةِ.",
    verb: "(ذَهَبَ - ir)",
  ...
  {
    question: "نَحْنُ ______ إِلَى الْمَسْجِدِ.",
    verb: "(ذَهَبَ - ir)",
  ...
  // -------------------- أَكَلَ (comer) --------------------
  {
    question: "أَنَا ______ التُّفَّاحَ.",
    verb: "(أَكَلَ - comer)",
  ...
  {
    question: "هُوَ ______ الْفَاكِهَةَ.",
    verb: "(أَكَلَ - هو - comer)",
    options: ["تَأْكُلُ", "نَأْكُلُ", "آكُلُ", "يَأْكُلُ"],
    correctAnswer: "يَأْكُلُ",
    trad: "Él come la fruta."
  },
  {
    question: "أَنْتُمْ ______ الْعَشَاءَ.",
    verb: "(أَكَلَ - comer)",
  ...
  // -------------------- شَرِبَ (beber) --------------------
  {
    question: "نَحْنُ ______ الْمَاءَ.",
    verb: "(شَرِبَ - beber)",
  ...
  // -------------------- نَامَ (dormir) --------------------
  {
    question: "الطِّفْلُ ______ مُبَكِّرًا.",
    verb: "(نَامَ - هو - dormir)",
    options: ["تَنَامُ", "أَنَامُ", "نَنَامُ", "يَنَامُ"],
    correctAnswer: "يَنَامُ",
    trad: "El niño duerme temprano."
  },
  {
    question: "أَنَا ______ كُلَّ لَيْلَةٍ.",
    verb: "(نَامَ - dormir)",
  ...
  {
    question: "هُمْ ______ فِي الْفُنْدُقِ.",
    verb: "(نَامَ - هم - dormir)",
  ...
  {
    question: "هُمْ ______ الْحَقِيقَةَ.",
    verb: "(عَرَفَ - هم - conocer)",
  ...
  // -------------------- رَأَى (ver) --------------------
  {
    question: "الرَّجُلُ ______ الْجَبَلَ.",
    verb: "(رَأَى - هو - ver)",
  ...
  {
    question: "أَنَا ______ صَدِيقِي.",
    verb: "(رَأَى - ver)",
  ...
  {
    question: "أَنْتُمْ ______ الْمُعَلِّمَ.",
    verb: "(رَأَى - ver)",
  ...
  {
    question: "الْأَطْفَالُ ______ فِي الْحَدِيقَةِ.",
    verb: "(لَعِبَ - هم - jugar)",
  ...
  // -------------------- قَالَ (decir) --------------------
  {
    question: "المُدِيرُ ______ كَلَامًا مُهِمًّا.",
    verb: "(قَالَ - هو - decir)",
  ...
  {
    question: "أَنْتِ ______ شَيْئًا جَمِيلًا.",
    verb: "(قَالَ - decir)",
  ...
  // -------------------- رَكِبَ (montar/subir) --------------------
  {
    question: "أَنَا ______ الْحَافِلَةَ.",
    verb: "(رَكِبَ - montar)",
  ...
  {
    question: "السَّائِحُ ______ الْجَمَلَ.",
    verb: "(رَكِبَ - هو - montar)",
    options: ["تَرْكَبُ", "أَرْكَبُ", "نَرْكَبُ", "يَرْكَبُ"],
    correctAnswer: "يَرْكَبُ",
    trad: "El turista monta el camello."
  },
  {
    question: "هُمْ ______ السَّفِينَةَ.",
    verb: "(رَكِبَ - هم - montar)",
  ...
  {
    question: "هِيَ ______ مِنَ السَّيَّارَةِ.",
    verb: "(نَزَلَ - هي - descender)",
  ...
  {
    question: "الْقِطَّةُ ______ الشَّجَرَةَ.",
    verb: "(صَعِدَ - هي - ascender)",
  ...
  // -------------------- بَدَأَ (empezar) --------------------
  {
    question: "الْيَوْمُ الدِّرَاسِيُّ ______ الْآنَ.",
    verb: "(بَدَأَ - هو - empezar)",
    options: ["تَبْدَأُ", "أَبْدَأُ", "نَبْدَأُ", "يَبْدَأُ"],
    correctAnswer: "يَبْدَأُ",
    trad: "El día escolar empieza ahora."
  },
  {
    question: "نَحْنُ ______ الْعَمَلَ.",
    verb: "(بَدَأَ - empezar)",
  ...
  {
    question: "هِيَ ______ فِي الْقِرَاءَةِ.",
    verb: "(بَدَأَ - هي - empezar)",
  ...
  // -------------------- خَرَجَ (salir) --------------------
  {
    question: "الْوَلَدُ ______ مِنَ الْبَيْتِ.",
    verb: "(خَرَجَ - هو - salir)",
    options: ["تَخْرُجُ", "أَخْرُجُ", "نَخْرُجُ", "يَخْرُجُ"],
    correctAnswer: "يَخْرُجُ",
    trad: "El niño sale de la casa."
  },
  {
    question: "أَنْتِ ______ لِلْعَمَلِ.",
    verb: "(خَرَجَ - salir)",
  ...
  {
    question: "الطُّلَّابُ ______ مِنَ الْمَدْرَسَةِ.",
    verb: "(خَرَجَ - هم - salir)",
  ...
  {
    question: "أَنْتُمْ ______ الْبَيْتَ.",
    verb: "(دَخَلَ - entrar)",
  ...
  // -------------------- نَظَرَ (mirar) --------------------
  {
    question: "البِنْتُ ______ إِلَى النَّافِذَةِ.",
    verb: "(نَظَرَ - هي - mirar)",
    options: ["يَنْظُرُ", "أَنْظُرُ", "نَنْظُرُ", "تَنْظُرُ"],
    correctAnswer: "تَنْظُرُ",
    trad: "La niña mira por la ventana."
  },
  {
    question: "أَنَا ______ إِلَى السَّمَاءِ.",
    verb: "(نَظَرَ - mirar)",
  ...
  {
    question: "هُمَا ______ إِلَى الْخَرِيطَةِ.",
    verb: "(نَظَرَ - هما - mirar)",
  ...
  // -------------------- نَسِيَ (olvidar) --------------------
  {
    question: "أَنَا ______ الْمِفْتَاحَ.",
    verb: "(نَسِيَ - olvidar)",
  ...
  {
    question: "هُوَ ______ الْوَعْدَ.",
    verb: "(نَسِيَ - هو - olvidar)",
    options: ["تَنْسَى", "أَنْسَى", "نَنْسَى", "يَنْسَى"],
    correctAnswer: "يَنْسَى",
    trad: "Él olvida la promesa."
  },
  {
    question: "أَنْتَ ______ أَيَّامَ الطُّفُولَةِ.",
    verb: "(نَسِيَ - olvidar)",
  ...
  // -------------------- جَرَى (correr) --------------------
  {
    question: "الْوَلَدُ ______ بِسُرْعَةٍ.",
    verb: "(جَرَى - هو - correr)",
    options: ["تَجْرِي", "أَجْرِي", "نَجْرِي", "يَجْرِي"],
    correctAnswer: "يَجْرِي",
    trad: "El niño corre rápidamente."
  },
  {
    question: "أَنَا ______ كُلَّ صَبَاحٍ.",
    verb: "(جَرَى - correr)",
  ...
  {
    question: "الْخَيْلُ ______ فِي الْمَيْدَانِ.",
    verb: "(جَرَى - هم - correr)",
  ...
  {
    question: "هُمْ ______ فِي الْمَطْبَخِ.",
    verb: "(طَبَخَ - هم - cocinar)",
  ...
  // -------------------- غَسَلَ (lavar) --------------------
  {
    question: "أَنْتَ ______ يَدَيْكَ.",
    verb: "(غَسَلَ - lavar)",
  ...
  {
    question: "هِيَ ______ الْمَلَابِسَ.",
    verb: "(غَسَلَ - هي - lavar)",
    options: ["يَغْسِلُ", "أَغْسِلُ", "نَغْسِلُ", "تَغْسِلُ"],
    correctAnswer: "تَغْسِلُ",
    trad: "Ella lava la ropa."
  },
  {
    question: "أَنَا ______ الْأَطْبَاقَ.",
    verb: "(غَسَلَ - lavar)",
  ...
  {
    question: "هِيَ ______ الْوُرُودَ.",
    verb: "(بَاعَ - هي - vender)",
  ...
  {
    question: "صَدِيقِي ______ فِي دُبَي.",
    verb: "(سَكَنَ - هو - residir)",
    options: ["تَسْكُنُ", "أَسْكُنُ", "نَسْكُنُ", "يَسْكُنُ"],
    correctAnswer: "يَسْكُنُ",
    trad: "Mi amigo reside en Dubái."
  },
  {
    question: "أَنَا ______ فِي بَيْتٍ جَدِيدٍ.",
    verb: "(سَكَنَ - residir)",
  ...
  {
    question: "هُمْ ______ فِي الْمَدِينَةِ.",
    verb: "(سَكَنَ - هم - residir)",
  ...
  // -------------------- عَاشَ (vivir) --------------------
  {
    question: "الْإِنْسَانُ ______ حَيَاةً وَاحِدَةً.",
    verb: "(عَاشَ - هو - vivir)",
  ...
  {
    question: "أَنَا ______ فِي سَلَامٍ.",
    verb: "(عَاشَ - vivir)",
  ...
  {
    question: "نَحْنُ ______ فِي هَذِهِ الْبَلْدَةِ.",
    verb: "(عَاشَ - vivir)",
  ...
  // -------------------- أَخَذَ (tomar) --------------------
  {
    question: "أَنَا ______ الْقَلَمَ مِنْ الطَّاوِلَةِ.",
    verb: "(أَخَذَ - tomar)",
  ...
  {
    question: "الْوَلَدُ ______ كِتَابًا مِنَ الرَّفِّ.",
    verb: "(أَخَذَ - هو - tomar)",
    options: ["تَأْخُذُ", "أَخُذُ", "نَأْخُذُ", "يَأْخُذُ"],
    correctAnswer: "يَأْخُذُ",
    trad: "El niño toma un libro del estante."
  },
  {
    question: "هُمْ ______ قَرَارًا مُهِمًّا.",
    verb: "(أَخَذَ - هم - tomar)",
  ...
  // -------------------- أَعْطَى (dar) --------------------
  {
    question: "الْمُعَلِّمُ ______ الطُّلَّابَ الدُّرُوسَ.",
    verb: "(أَعْطَى - هو - dar)",
  ...
  {
    question: "أَنَا ______ الصَّدَقَةَ لِلْفُقَرَاءِ.",
    verb: "(أَعْطَى - dar)",
  ...
  {
    question: "هِيَ ______ الْهَدِيَّةَ لِصَدِيقَتِهَا.",
    verb: "(أَعْطَى - هي - dar)",
  ...
  {
    question: "أَنْتَ ______ الْمُسَاعَدَةَ.",
    verb: "(طَلَبَ - pedir)",
  ...
  {
    question: "الطَّالِبُ ______ الْكِتَابَ مِنَ الْمَكْتَبَةِ.",
    verb: "(طَلَبَ - هو - pedir)",
    options: ["تَطْلُبُ", "أَطْلُبُ", "نَطْلُبُ", "يَطْلُبُ"],
    correctAnswer: "يَطْلُبُ",
    trad: "El estudiante pide el libro de la biblioteca."
  },
  {
    question: "هُمْ ______ حُقُوقَهُمْ.",
    verb: "(طَلَبَ - هم - solicitar)",
  ...
  // -------------------- بَكَى (llorar) --------------------
  {
    question: "الطِّفْلَةُ ______ بِصَوْتٍ عَالٍ.",
    verb: "(بَكَى - هي - llorar)",
    options: ["يَبْكِي", "أَبْكِي", "نَبْكِي", "تَبْكِي"],
    correctAnswer: "تَبْكِي",
    trad: "La niña llora en voz alta."
  },
  {
    question: "أَنَا ______ عِنْدَمَا أَحْزَنُ.",
    verb: "(بَكَى - llorar)",
  ...
  {
    question: "هُمْ ______ بِسَبَبِ الْخَبَرِ.",
    verb: "(بَكَى - هم - llorar)",
  ...
  {
    question: "هِيَ ______ الْقِرَاءَةَ.",
    verb: "(أَحَبَّ - هي - amar)",
  ...
  {
    question: "هُمْ ______ الضَّوْضَاءَ.",
    verb: "(كَرِهَ - هم - odiar)",
  ...
  {
    question: "الْمُسْلِمُ ______ مُبَكِّرًا لِصَلَاةِ الْفَجْرِ.",
    verb: "(اِسْتَيْقَظَ - هو - despertarse)",
  ...
  {
    question: "أَنَا ______ فِي السَّادِسَةِ صَبَاحًا.",
    verb: "(اِسْتَيْقَظَ - despertarse)",
  ...
  {
    question: "هِيَ ______ بِسُرْعَةٍ.",
    verb: "(اِسْتَيْقَظَ - هي - despertarse)",
  ...
  // -------------------- وَصَلَ (llegar) --------------------
  {
    question: "الْقِطَارُ ______ إِلَى الْمَحَطَّةِ.",
    verb: "(وَصَلَ - هو - llegar)",
    options: ["تَصِلُ", "أَصِلُ", "نَصِلُ", "يَصِلُ"],
    correctAnswer: "يَصِلُ",
    trad: "El tren llega a la estación."
  },
  {
    question: "أَنَا ______ الْبَيْتَ الْآنَ.",
    verb: "(وَصَلَ - llegar)",
  ...
  {
    question: "هُمْ ______ مُتَأَخِّرِينَ.",
    verb: "(وَصَلَ - هم - llegar)",
  ...
  // -------------------- بَحَثَ (buscar) --------------------
  {
    question: "الطَّالِبُ ______ عَنِ الْكِتَابِ.",
    verb: "(بَحَثَ - هو - buscar)",
    options: ["تَبْحَثُ", "أَبْحَثُ", "نَبْحَثُ", "يَبْحَثُ"],
    correctAnswer: "يَبْحَثُ",
    trad: "El estudiante busca el libro."
  },
  {
    question: "أَنَا ______ عَنْ عَمَلٍ جَدِيدٍ.",
    verb: "(بَحَثَ - buscar)",
  ...
  {
    question: "هِيَ ______ عَنْ إِجَابَةٍ.",
    verb: "(بَحَثَ - هي - buscar)",
  ...
  {
    question: "الرَّجُلُ ______ الْحَقِيبَةَ الثَّقِيلَةَ.",
    verb: "(حَمَلَ - هو - llevar)",
    options: ["تَحْمِلُ", "أَحْمِلُ", "نَحْمِلُ", "يَحْمِلُ"],
    correctAnswer: "يَحْمِلُ",
    trad: "El hombre lleva la maleta pesada."
  },
  {
    question: "أَنَا ______ الْأَزْهَارَ.",
    verb: "(حَمَلَ - llevar)",
  ...
  {
    question: "هِيَ ______ طِفْلَهَا.",
    verb: "(حَمَلَ - هي - llevar)",
  ...
  // -------------------- صَلَّى (orar/rezar) --------------------
  {
    question: "الْمُسْلِمُ ______ فِي الْمَسْجِدِ.",
    verb: "(صَلَّى - هو - orar)",
  ...
  {
    question: "أَنَا ______ خَمْسَ مَرَّاتٍ فِي الْيَوْمِ.",
    verb: "(صَلَّى - orar)",
  ...
  {
    question: "هُمْ ______ الْجُمُعَةَ.",
    verb: "(صَلَّى - هم - orar)",
  ...
  // -------------------- عَبَدَ (adorar) --------------------
  {
    question: "نَحْنُ ______ اللَّهَ وَحْدَهُ.",
    verb: "(عَبَدَ - adorar)",
  ...
  {
    question: "الْمُؤْمِنُ ______ رَبَّهُ بِإِخْلَاصٍ.",
    verb: "(عَبَدَ - هو - adorar)",
    options: ["تَعْبُدُ", "أَعْبُدُ", "نَعْبُدُ", "يَعْبُدُ"],
    correctAnswer: "يَعْبُدُ",
    trad: "El creyente adora a su Señor con sinceridad."
  },
  {
    question: "هُمْ ______ اللَّهَ فِي كُلِّ الْأَحْوَالِ.",
    verb: "(عَبَدَ - هم - adorar)",
  ...
  {
    question: "أَنَا ______ لِلَّهِ فِي كُلِّ رَكْعَةٍ.",
    verb: "(سَجَدَ - postrarse en oración)",
    options: ["يَسْجُدُ", "تَسْجُدُ", "نَسْجُدُ", "أَسْجُدُ"],
    correctAnswer: "أَسْجُدُ",
    trad: "Yo me postro ante Allah en cada rak'ah."
  },
  {
    question: "الْمُسْلِمُونَ ______ بَعْدَ الرُّكُوعِ.",
    verb: "(سَجَدَ - هم - postrarse en oración)",
  ...
  {
    question: "هِيَ ______ عَلَى جَبْهَتِهَا.",
    verb: "(سَجَدَ - هي - postrarse en oración)",
  ...
  // -------------------- آمَنَ (creer) --------------------
  {
    question: "الْمُؤْمِنُ ______ بِاللَّهِ وَرُسُلِهِ.",
    verb: "(آمَنَ - هو - creer)",
  ...
  {
    question: "أَنَا ______ بِقَدَرِ اللَّهِ.",
    verb: "(آمَنَ - creer)",
  ...
  {
    question: "هُمْ ______ بِالْيَوْمِ الْآخِرِ.",
    verb: "(آمَنَ - هم - creer)",
  ...
  {
    question: "الْمُسْلِمُ ______ عَلَى اللَّهِ.",
    verb: "(تَوَكَّلَ - هو - confiar en Dios)",
    options: ["تَتَوَكَّلُ", "أَتَوَكَّلُ", "نَتَوَكَّلُ", "يَتَوَكَّلُ"],
    correctAnswer: "يَتَوَكَّلُ",
    trad: "El musulmán confía en Allah."
  },
  {
    question: "أَنَا ______ عَلَى رَبِّي فِي كُلِّ أَمْرٍ.",
    verb: "(تَوَكَّلَ - confiar en Dios)",
  ...
  {
    question: "هُمْ ______ عَلَى اللَّهِ بَعْدَ الْأَخْذِ بِالْأَسْبَابِ.",
    verb: "(تَوَكَّلَ - هم - confiar en Dios)",
  ...
  {
    question: "الْعَبْدُ ______ رَبَّهُ بِالدُّعَاءِ.",
    verb: "(دَعَا - هو - suplicar)",
    options: ["تَدْعُو", "أَدْعُو", "نَدْعُو", "يَدْعُو"],
    correctAnswer: "يَدْعُو",
    trad: "El siervo suplica a su Señor con súplica."
  },
  {
    question: "أَنَا ______ اللَّهَ لِيَغْفِرَ لِي.",
    verb: "(دَعَا - suplicar)",
  ...
  {
    question: "هُمْ ______ النَّاسَ إِلَى الْإِسْلَامِ.",
    verb: "(دَعَا - هم - llamar/invitar)",
  ...
  {
    question: "الْمُسْلِمُ ______ رَبَّهُ بَعْدَ الصَّلَاةِ.",
    verb: "(سَبَّحَ - هو - glorificar)",
  ...
  {
    question: "أَنَا ______ اللَّهَ بِحَمْدِهِ.",
    verb: "(سَبَّحَ - glorificar)",
    options: ["يُسَبِّحُ", "تُسَبِّحُ", "نُسَبِّحُ", "أُسَبِّحُ"],
    correctAnswer: "أُسَبِّحُ",
    trad: "Yo glorifico a Allah con Su alabanza."
  },
  {
    question: "هُمْ ______ بِحَمْدِ رَبِّهِمْ.",
    verb: "(سَبَّحَ - هم - glorificar)",
  ...
  {
    question: "الْعَبْدُ ______ رَبَّهُ مِنْ ذَنْبِهِ.",
    verb: "(اِسْتَغْفَرَ - هو - pedir perdón)",
  ...
  {
    question: "أَنَا ______ اللَّهَ كُلَّ يَوْمٍ.",
    verb: "(اِسْتَغْفَرَ - pedir perdón)",
  ...
  {
    question: "هُمْ ______ بَعْدَ كُلِّ خَطَأٍ.",
    verb: "(اِسْتَغْفَرَ - هم - pedir perdón)",
  ...
  // -------------------- صَامَ (ayunar) --------------------
  {
    question: "الْمُسْلِمُ ______ شَهْرَ رَمَضَانَ.",
    verb: "(صَامَ - هو - ayunar)",
    options: ["تَصُومُ", "أَصُومُ", "نَصُومُ", "يَصُومُ"],
    correctAnswer: "يَصُومُ",
    trad: "El musulmán ayuna el mes de Ramadán."
  },
  {
    question: "أَنَا ______ يَوْمَ عَرَفَةَ.",
    verb: "(صَامَ - ayunar)",
  ...
  {
    question: "هُمْ ______ لِلَّهِ تَعَالَى.",
    verb: "(صَامَ - هم - ayunar)",
  ...
  {
    question: "الْغَنِيُّ ______ مَالَهُ لِلْفُقَرَاءِ.",
    verb: "(زَكَى - هو - pagar el zakat)",
    options: ["تُزَكِّي", "أُزَكِّي", "نُزَكِّي", "يُزَكِّي"],
    correctAnswer: "يُزَكِّي",
    trad: "El rico paga su zakat a los pobres."
  },
  {
    question: "أَنَا ______ عَنْ مَالِي.",
    verb: "(زَكَى - pagar el zakat)",
    options: ["يُزَكِّي", "تُزَكِّي", "نُزَكِّي", "أُزَكِّي"],
    correctAnswer: "أُزَكِّي",
    trad: "Yo purifico mi riqueza."
  },
  {
    question: "هُمْ ______ أَنْفُسَهُمْ بِالتَّقْوَى.",
    verb: "(زَكَى - هم - purificar)",
  ...
  {
    question: "الْحَاجُّ ______ بِالْكَعْبَةِ سَبْعًا.",
    verb: "(طَافَ - هو - circunvalar)",
    options: ["تَطُوفُ", "أَطُوفُ", "نَطُوفُ", "يَطُوفُ"],
    correctAnswer: "يَطُوفُ",
    trad: "El peregrino circunvala la Kaaba siete veces."
  },
  {
    question: "أَنَا ______ حَوْلَ الْكَعْبَةِ.",
    verb: "(طَافَ - circunvalar)",
    options: ["يَطُوفُ", "تَطُوفُ", "نَطُوفُ", "أَطُوفُ"],
    correctAnswer: "أَطُوفُ",
    trad: "Yo circunvalo la Kaaba."
  },
  {
    question: "هُمْ ______ بَيْنَ الصَّفَا وَالْمَرْوَةِ.",
    verb: "(طَافَ - هم - recorrer)",
  ...
  {
    question: "الْمُسْلِمُ ______ بَيْتَ اللَّهِ الْحَرَامَ.",
    verb: "(حَجَّ - هو - realizar el Hajj)",
  ...
  {
    question: "أَنَا ______ الْبَيْتَ الْحَرَامَ هَذَا الْعَامَ.",
    verb: "(حَجَّ - realizar el Hajj)",
  ...
  {
    question: "هُمْ ______ فِي مَوَاعِيدِ الْحَجِّ.",
    verb: "(حَجَّ - هم - realizar el Hajj)",
  ...
  {
    question: "الْحَاكِمُ الْعَادِلُ ______ أَمْرَ النَّاسِ.",
    verb: "(وَلِيَ - هو - gobernar)",
    options: ["تَلِي", "أَلِي", "نَلِي", "يَلِي"],
    correctAnswer: "يَلِي",
    trad: "El gobernante justo se encarga de los asuntos de la gente."
  },
  {
    question: "هِيَ ______ شُؤُونَ الْبَيْتِ.",
    verb: "(وَلِيَ - هي - encargarse)",
    options: ["يَلِي", "أَلِي", "نَلِي", "تَلِي"],
    correctAnswer: "تَلِي",
    trad: "Ella se encarga de los asuntos de la casa."
  },
  {
    question: "هُمْ ______ مَصَالِحَ الْأُمَّةِ.",
    verb: "(وَلِيَ - هم - encargarse)",
  ...
  {
    question: "الْمُؤْمِنُ ______ اللَّهَ فِي السِّرِّ وَالْعَلَنِ.",
    verb: "(اِتَّقَى - هو - temer a Dios)",
    options: ["تَتَّقِي", "أَتَّقِي", "نَتَّقِي", "يَتَّقِي"],
    correctAnswer: "يَتَّقِي",
    trad: "El creyente teme a Allah en secreto y en público."
  },
  {
    question: "أَنَا ______ اللَّهَ حَيْثُمَا كُنْتُ.",
    verb: "(اِتَّقَى - temer a Dios)",
    options: ["يَتَّقِي", "تَتَّقِي", "نَتَّقِي", "أَتَّقِي"],
    correctAnswer: "أَتَّقِي",
    trad: "Yo temo a Allah dondequiera que esté."
  },
  {
    question: "هُمْ ______ اللَّهَ حَقَّ تُقَاتِهِ.",
    verb: "(اِتَّقَى - هم - temer a Dios)",
  ...
  // -------------------- اِسْتَعْمَلَ (usar) --------------------
  {
    question: "أَنْتَ ______ الْقَلَمَ لِكِتَابَةِ الْوَاجِبِ.",
    verb: "(اِسْتَعْمَلَ - usar)",
  ...
  {
    question: "هُوَ ______ الْكُمَبْيُوتَرَ.",
    verb: "(اِسْتَعْمَلَ - هو - usar)",
    options: ["تَسْتَعْمِلُ", "أَسْتَعْمِلُ", "نَسْتَعْمِلُ", "يَسْتَعْمِلُ"],
    correctAnswer: "يَسْتَعْمِلُ",
    trad: "Él usa el ordenador."
  },
  {
    question: "نَحْنُ ______ الْهَوَاتِفَ الذَّكِيَّةَ.",
    verb: "(اِسْتَعْمَلَ - usar)",
  ...
  // -------------------- تَذَكَّرَ (recordar) --------------------
  {
    question: "الْوَلَدُ ______ دُرُوسَهُ.",
    verb: "(تَذَكَّرَ - هو - recordar)",
    options: ["تَتَذَكَّرُ", "أَتَذَكَّرُ", "نَتَذَكَّرُ", "يَتَذَكَّرُ"],
    correctAnswer: "يَتَذَكَّرُ",
    trad: "El niño recuerda sus lecciones."
  },
  {
    question: "أَنَا ______ أَحْدَاثَ الْمَاضِي.",
    verb: "(تَذَكَّرَ - recordar)",
  ...
  {
    question: "هُمْ ______ اللَّهَ كَثِيرًا.",
    verb: "(تَذَكَّرَ - هم - recordar)",
  ...
  // -------------------- تَعَاوَنَ (cooperar) --------------------
  {
    question: "الطُّلَّابُ ______ فِي الْمَشْرُوعِ.",
    verb: "(تَعَاوَنَ - هم - cooperar)",
  ...
  // -------------------- أَرْسَلَ (enviar) --------------------
  {
    question: "الرَّسُولُ ______ رِسَالَةً.",
    verb: "(أَرْسَلَ - هو - enviar)",
    options: ["تُرْسِلُ", "أُرْسِلُ", "نُرْسِلُ", "يُرْسِلُ"],
    correctAnswer: "يُرْسِلُ",
    trad: "El mensajero envía un mensaje."
  },
  {
    question: "أَنَا ______ الْبَرِيدَ الْإِلِكْتُرُونِيَّ.",
    verb: "(أَرْسَلَ - enviar)",
    options: ["يُرْسِلُ", "تُرْسِلُ", "نُرْسِلُ", "أُرْسِلُ"],
    correctAnswer: "أُرْسِلُ",
    trad: "Yo envío el correo electrónico."
  },
  {
    question: "هُمْ ______ هَدَايَا لِأَصْدِقَائِهِمْ.",
    verb: "(أَرْسَلَ - هم - enviar)",
  ...
  // -------------------- أَجَابَ (responder) --------------------
  {
    question: "الطَّالِبُ ______ عَلَى السُّؤَالِ.",
    verb: "(أَجَابَ - هو - responder)",
    options: ["تُجِيبُ", "أُجِيبُ", "نُجِيبُ", "يُجِيبُ"],
    correctAnswer: "يُجِيبُ",
    trad: "El estudiante responde a la pregunta."
  },
  {
    question: "أَنَا ______ عَلَى الْهَاتِفِ.",
    verb: "(أَجَابَ - responder)",
  ...
  // -------------------- أَكْمَلَ (completar) --------------------
  {
    question: "الْعَامِلُ ______ عَمَلَهُ.",
    verb: "(أَكْمَلَ - هو - completar)",
    options: ["تُكْمِلُ", "أُكْمِلُ", "نُكْمِلُ", "يُكْمِلُ"],
    correctAnswer: "يُكْمِلُ",
    trad: "El trabajador completa su trabajo."
  },
  {
    question: "أَنَا ______ دِرَاسَتِي هَذَا الْعَامَ.",
    verb: "(أَكْمَلَ - completar)",
    options: ["يُكْمِلُ", "تُكْمِلُ", "نُكْمِلُ", "أُكْمِلُ"],
    correctAnswer: "أُكْمِلُ",
    trad: "Yo completo mis estudios este año."
  },
  {
    question: "هُمْ ______ مَهَامَّهُمْ قَبْلَ الْمَوْعِدِ النِّهَائِيِّ.",
    verb: "(أَكْمَلَ - هم - completar)",
  ...
  // -------------------- أَرَادَ (querer) --------------------
  {
    question: "هُوَ ______ أَنْ يَكُونَ طَبِيبًا.",
    verb: "(أَرَادَ - هو - querer)",
    options: ["تُرِيدُ", "أُرِيدُ", "نُرِيدُ", "يُرِيدُ"],
    correctAnswer: "يُرِيدُ",
    trad: "Él quiere ser médico."
  },
  {
    question: "أَنَا ______ أَنْ أَتَعَلَّمَ الْعَرَبِيَّةَ.",
    verb: "(أَرَادَ - querer)",
  ...
  {
    question: "هُمْ ______ الْعَدْلَ فِي كُلِّ شَيْءٍ.",
    verb: "(أَرَادَ - هم - querer)",
            ...
            <div className={`feedback${isCorrect ? " correct" : " wrong"}`}>
              {isCorrect ? (
                ...
                <>
                  {!showCorrect ? (
                    <>
                      <div className="wrong-answer">إِجَابَةٌ غَيْرُ صَحِيحَةٍ.</div>
                      <div className="wrong-btns" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.7em", marginTop: "1em" }}>
                        ...
                        <button
                          ...
                          style={{ width: "220px" }}
                        >
                          الإِجَابَة الصَّحِيحَة
                        </button>
                      </div>
                    </>
                  ) : (
                    <>
                      <div className="correct-answer-label">الإِجَابَةُ الصَّحِيحَة:</div>
                      <div className="correct-answer-value">{questions[currentQuestion].correctAnswer}</div>
                      <div className="show-trad" dir="ltr">{questions[currentQuestion].trad}</div>
                      {currentQuestion < questions.length - 1 ? (
                        <button className="next-q-btn" onClick={handleNext}>
                          السُّؤَالُ التَّالِي
                        </button>
